<template>
  <div>
    ...
    <!-- 添加角色对话框 -->
    <el-dialog title="添加角色" :visible.sync="addDialogVisible" width="50%" @close="addFromClose">
    ...
    <!-- 编辑角色对话框 -->
    <el-dialog title="编辑角色信息" :visible.sync="editDialogVisible" width="50%" @click="editFromClose">
    ...
    <el-dialog title="分配权限" :visible.sync="rightsDialogVisible" width="50%">
      <!-- 属性结构 -->
      <el-tree :data="rightsTree" :props="treeProps" ref="treeRef"
      node-key="id" :default-expand-all="true" :default-checked-keys="rightIds"
      show-checkbox>
      </el-tree>
      <span slot="footer" class="dialog-footer">
